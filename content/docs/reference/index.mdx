...
The upstream rename is transitional. Prefer the upstream-published command when installing; treat OpenAgent names as the public product identity.

| Name | Purpose |
|---|---|
| `oh-my-opencode` | Current upstream npm package and primary installer command. |
| `oh-my-openagent` | Compatibility binary and product name during the rename transition. |
